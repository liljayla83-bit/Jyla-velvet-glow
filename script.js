...
document.addEventListener('DOMContentLoaded', function () {
    ...
    checkoutForm.addEventListener('submit', function (e) {
        ...
        const body = `
          Hello Beautiful,welcome to Jyla Velvet Glow where your glow begins.
        ...
        const mailtoLink = `mailto:janet.amenyo@outlook.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
